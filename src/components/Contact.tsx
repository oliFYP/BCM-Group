            ...
            <div className="lg:col-span-3 bg-bcm-coal border border-white/5 p-8 md:p-10">
              ...
              {sent ? (
                <div className="flex flex-col items-center justify-center text-center py-12 gap-4">
                  ...
                  <h3 className="font-['Barlow_Condensed'] font-bold text-2xl uppercase text-white">
                    Message envoyé!
                  </h3>
                  <p className="text-bcm-silver max-w-sm">
                    Merci de nous avoir contactés. Un membre de notre équipe
                    vous répondra dans les 24 heures ouvrables.
                  </p>
                  <button
                    onClick={() => setSent(false)}
                    className="btn-ghost-red mt-2"
                  >
              ...
              <div className="bg-bcm-red p-7 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/75 text-sm mb-5 leading-relaxed">
                    Notre équipe est disponible du lundi au vendredi, de 8h à
                    17h.
                  </p>
                  <a
                    href="tel:450-741-1351"
                    className="inline-flex items-center gap-2 bg-white text-bcm-red font-['Barlow_Condensed'] font-bold text-sm tracking-widest uppercase px-6 py-3 hover:bg-bcm-light transition-colors"
                  >
                    <Phone size={15} />
                    450-741-1351
                  </a>
